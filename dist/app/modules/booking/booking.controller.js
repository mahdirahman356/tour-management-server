...
const getAllBookings = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const bookings = yield booking_service_1.BookingService.getAllBookings(query);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
        message: "Bookings retrieved successfully",
...
const updateBookingStatus = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const bookingId = req.params.bookingId;
    const updated = yield booking_service_1.BookingService.updateBookingStatus(status, bookingId);
    (0, sendResponse_1.sendResponse)(res, {
        statusCode: 200,
        success: true,
