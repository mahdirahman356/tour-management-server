...
const failPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    session.startTransaction();
    try {
        const updatePayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, { status: payment_interface_1.PAYMENT_STATUS.FAILED }, { new: true, runValidators: true, session: session });
        yield booking_model_1.Booking
            .findByIdAndUpdate(updatePayment === null || updatePayment === void 0 ? void 0 : updatePayment.booking, { status: booking_interface_1.BOOKING_STATUS.FAILED }, { runValidators: true, session });
        yield session.commitTransaction();
        session.endSession();
...
const cancelPayment = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    session.startTransaction();
    try {
        const updatePayment = yield payment_model_1.Payment.findOneAndUpdate({ transactionId: query.transactionId }, { status: payment_interface_1.PAYMENT_STATUS.CANCELLED }, { new: true, runValidators: true, session: session });
        yield booking_model_1.Booking
            .findByIdAndUpdate(updatePayment === null || updatePayment === void 0 ? void 0 : updatePayment.booking, { status: booking_interface_1.BOOKING_STATUS.CANCEL }, { runValidators: true, session });
        yield session.commitTransaction();
        session.endSession();
